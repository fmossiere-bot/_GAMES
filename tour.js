  ...
  function steps(name) {
    ...
    return [
      { pose: 'wave', hat: 'hat', tee: 'eco',
        ...
        sub: 'I\'m an astronaut, believe it or not, and Ireland is my first stop. Every day I\'ll hand you three ways to play your part: a game, a story or an action. Pick one and your streak keeps going. One a day is the rhythm, two is the cap.',
        art: ways, lift: false },
      { pose: 'point', hat: 'cap', tee: 'eco',
        head: 'Four tabs, that\'s all.',
        sub: 'Home is where I hand you today\'s pick. Games and Stories hold the whole library if you\'d rather choose your own. Companion is me, ask away.',
        art: tabs, lift: true },
      { pose: 'stand', hat: 'cap', tee: 'science',
        head: 'Ask me anything about climate.',
        sub: 'I answer from our own checked wiki first, and I say so when I fall back to general AI. Heard a claim down the pub? I can take it apart and hand you what to say back.',
        art: ask, lift: false },
      { pose: 'celebrate', hat: 'hat', tee: 'eco',
        head: 'Points become real things.',
        sub: 'Games, stories and actions all earn points. Every 1,500 becomes an impact credit, and a credit becomes a native tree or a patch of meadow with our partners. Right, pick one.',
